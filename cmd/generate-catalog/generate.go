...
const (
	...
	bundleDeprecationMessage        = "This operator version is no longer supported. Please switch to a newer version that's still in support. Find supported versions in RHACS support policy document: https://access.redhat.com/support/policy/updates/rhacs \n"
	bundleBrokenMessage             = "This operator version is broken and should not be used. Please switch to a newer version that's still in support. Find supported versions in RHACS support policy document: https://access.redhat.com/support/policy/updates/rhacs \n"
