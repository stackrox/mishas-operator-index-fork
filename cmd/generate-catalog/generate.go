...
const (
	...
	bundleDeprecationMessage        = "This Operator version is no longer supported. Use a later version that is supported. Find supported versions in the RHACS support policy document: https://access.redhat.com/support/policy/updates/rhacs"
	bundleBrokenMessage             = "This Operator version is broken and should not be used. Use a later version that is supported.  Find supported versions in the RHACS support policy document: https://access.redhat.com/support/policy/updates/rhacs"
