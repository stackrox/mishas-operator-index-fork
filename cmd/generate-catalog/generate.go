...
const (
	...
	iconFile                        = "icon.png"
	firstLineHeadComment            = "This file is generated by cmd/generate-catalog/generate.go script. DO NOT EDIT."
...
func main() {
	...
	err = catalog.writeCatalogTemplateToFile()
	if err != nil {
		...
		if v.Patch() == 0 {
			...
			if v.Original() != "3.63.0" {
				if channel != nil {
					...
					// Also add "latest" channel when all "3.X.X" version are processed
					if v.Original() == "4.0.0" {
